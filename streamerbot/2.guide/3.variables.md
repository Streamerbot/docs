...
::callout{icon=i-mdi-bookmark color=green to=/api/sub-actions/core/variables/global-get-variable}
Read more about Global and User Variables in the [Core Sub-Actions](/api/sub-actions/core/variables/global-get-variable) API References
::
