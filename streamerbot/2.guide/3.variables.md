...
::callout{icon=i-mdi-bookmark color=green to=/api/sub-actions/general/core/variables/global-get-variable}
Read more about Global and User Variables in the [Core Sub-Actions](/api/sub-actions/general/core/variables/global-get-variable) API References
::
...
::field-group
  ...
  Requires C# to access, [read more](/api/csharp/general/core#advanced)
  ::
