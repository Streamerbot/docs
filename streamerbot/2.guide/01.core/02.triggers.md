...
:kbd{value="Right-Click"} anywhere in the triggers pane (or click the `+` icon in the top right) to browse triggers and add them to your selected action.
...
:kbd{value="Right-Click"} any existing trigger to reveal additional context menu options:
