...
:kbd{value="Right-Click"} in the commands pane to add your first voice command!
...
:read-more{to="/api/triggers/core/voice-control"}
...
::tip
The logger is useful for debugging your speech dictation!
::
