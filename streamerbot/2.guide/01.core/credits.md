---
title: Credits
description: Configure the built-in Credits system in Streamer.bot
---

Streamer.bot has a built in 'Credits' system. It allows Broadcasters to display the different events that occurred throughout the stream.
