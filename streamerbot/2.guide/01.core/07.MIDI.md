...
This will open the add device dialog with the following configuration options:
...
:read-more{to=/api/sub-actions/core/midi}
:read-more{to=/api/triggers/core/midi/message}
