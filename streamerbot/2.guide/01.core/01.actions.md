...
::navigate
To get started, navigate to **Actions & Queues > Actions** in Streamer.bot
::

![Streamer.bot Actions View](assets/view-actions.png)

The actions view is split into 3 main parts:
...
![Add Action Dialog](assets/add-action-dialog.png)
...
<br><br>
This can be used used to organize similar actions into collapsible sections to keep the interface clean if you have a large number of actions
:::
...
![Sub-Actions Pane](assets/sub-actions.png)
...
::::tip
Setting a group to Random will also enable the `Weight` options on sub-actions inside that group.<br>
...
::navigate
To get started, navigate to **Actions & Queues > Queues** in Streamer.bot
::

![Queues List View](assets/view-queues.png)
...
::note
**When utilizing blocking queues**, all currently blocked actions will show here.
::
...
![Action Queues > Action History View](assets/view-action-history.png)
...
![Action History > Inspect Variables Dialog](assets/action-history-variables.png)
::::
:::
