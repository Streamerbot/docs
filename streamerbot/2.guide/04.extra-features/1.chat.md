...
author:
  ...
  description: Streamer.bot Chat created by Whipstickgostop
  avatar: https://streamer.bot/img/wsgs.jpg
  url: https://github.com/Whipstickgostop
---
...
![Chat Overlay Preview](./assets/chat-overlay.gif){width="600"}
...
Some chat slash commands can manipulate the chat overlay:

::field-group
:::field{name="/clear/overlay" type="Slash Command"}
Clears the chat overlay without affecting the main chat window history.
::::warning
This command is only availalbe in the main Streamer.bot chat window and will not work in docked chat
::::
:::

:::field{name="/clear" type="Slash Command"}
Clears the chat history for all OBS Browser Sources, including the chat overlay.

::::warning
This command only clears the chat overlay when used from an **OBS Browser Dock**
::::
:::
::
...
**Event Wrapper**{.font-mono}

:br
`[data-event-id="1001"][data-event-source="Twitch"][data-event-type="ChatMessage"]`{lang=css}

:::callout{color=important}
**Message Container**{.font-mono}
:br
`[data-slot="root"][data-platform="twitch"][data-user-id="12345678"][data-username="lyfesaver74"][data-display-name="Lyfesaver74"]`{lang=css}

::::callout{color=important}
**Message Body**{.font-mono}
:br
`[data-slot="body"]`{lang=css}

:::::div{class="flex items-end gap-2"}
::::::callout{color=important class="inline my-auto min-w-fit"}
**Leading**{.font-mono}
:br
`[data-slot="leading"]`{lang=css}

::::::
::::::callout{color=important class="inline my-auto w-full"}
**Content**{.font-mono}
:br
`[data-slot="content"]`{lang=css}
...
These attributes are available on **all** rows visible in chat, _including chat messages_.
