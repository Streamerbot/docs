...
* Added **24** new `triggers` for the `Elgato Prompter`
* Added **12** new `sub-actions` for the `Elgato Prompter`
* Added **35** new `triggers` for `Elgato Camera Hub Webcam`
