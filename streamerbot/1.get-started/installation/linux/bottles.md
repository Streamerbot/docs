...
- In some runners or graphic cards, **DXVK** and **VKD3D** may cause the UI to glitch or freeze completely. You can set both to `Disabled` in the bottle setttings to fix this.
